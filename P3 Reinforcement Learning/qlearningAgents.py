    ...
    def computeActionFromQValues(self, state):
        ...
        for action in self.getLegalActions(state):
            if bestQValue == self.getQValue(state, action):
                bestEqualActions.append(action)

        return random.choice(bestEqualActions)
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        for keyStateActio in features.keys():
            self.weights[keyStateActio] = self.weights[keyStateActio] + self.alpha * difference * features[keyStateActio]
        # util.raiseNotDefined()
